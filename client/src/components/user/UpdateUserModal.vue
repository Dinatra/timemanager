        ...
        <div class="min-h-screen px-4 text-center">
          ...
          >
            ...
            >
              ...
              >
                tous -> {{ userData }}
                Mise à jour de votre compte utilisateur
              </DialogTitle>
              <div class="mt-10">
                <form action="">
                  <div class="mb-3">
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    onMounted(() => {
      if (props.userData) {
        userFormData.id = props.userData.id;
        userFormData.username = props.userData.username;
        userFormData.email = props.userData.email;
      }
    });
